...
class AutoCompeleteTextFieldSearchCountry extends StatefulWidget {
  ...
  AutoCompeleteTextFieldSearchCountry(
      {Key key,
...
class _MACTextFieldState extends State<AutoCompeleteTextFieldSearchCountry> {
  List<String> _list = [];
          ...
          Theme(
            child: Card(
              shape: RoundedRectangleBorder(
                  borderRadius: widget.borderRidus == null
              ...
              elevation: (widget.background == null ||
  ...
  Widget _nonCollapsed(List sList, indx) {
    ...
    return ListTile(
      ...
      onTap: () {
        setState(() {
          appStates.filledSearchCountry.value
              .add(FilledCountrySearch(tag: sList[indx].toString()));
          widget.controller.clear();
          _list.clear();
          _size = 0.0;
        });
